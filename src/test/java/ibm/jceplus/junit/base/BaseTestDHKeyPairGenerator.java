...
public class BaseTestDHKeyPairGenerator extends BaseTest {

    private static BigInteger p_1024;
    private static BigInteger g_1024;
    private static BigInteger p_2048;
    private static BigInteger g_2048;
    private static BigInteger p_3072;
    private static BigInteger g_3072;
    private static BigInteger p_4096;
    private static BigInteger g_4096;
    private static BigInteger p_6144;
    private static BigInteger g_6144;
    private static BigInteger p_8192;
    private static BigInteger g_8192;
    ...
    static {
        ...
        g_2048 = new BigInteger("2");

        // p,g, 3072
        p_3072 = new BigInteger(
        ...
        g_3072 = new BigInteger("2");

        // p,g, 4096



        p_4096 = new BigInteger("00bffcbc796f5f5abc038bd0f5425b" + "434c9c841b61aeada4babb733fed0f"
                ...
                16);
        g_4096 = new BigInteger("5", 16);


        // p,g, 6144
        p_6144 = new BigInteger("00ee44c7210997bc150de5179bdd70" + "11f9cb032d8c2d6ffda5d45f9e7166"
        ...
        p_8192 = new BigInteger("00c164c46dbb0596c77938a260999a" + "bfec25cc6368e789f1483891784d35"
        ...
        g_8192 = new BigInteger("5", 16);

    }



    public BaseTestDHKeyPairGenerator(String providerName) {
        super(providerName);
    }
    ...
    protected void setUp() throws Exception {
        super.setUp();
        kpg = KeyPairGenerator.getInstance("DH", providerName);
    ...
    /*
     * test case from Oracle Security-in-Depth Fix 8293554: Enhanced DH Key
     * Exchanges Bring key sizes more in line with public standards (e.g., NIST SP
     * 800-56A) Problem Report 148149
     *
     */
    public void testDefaultDHPrivateExpSize() throws Exception {
        ...
        System.out.println("Testing provider: " + providerName + " DH private exponenent size");
        ...
        for (int keypairSize : keypairSizes) {
            ...
            try {
                ...
                if ((PROVIDER_OPENJCEPlusFIPS.equalsIgnoreCase(providerName)
                        || PROVIDER_OPENJCEPlus.equalsIgnoreCase(providerName))
                        && (keypairSize == 1536)) {
                    System.out.print("Keysize 1536 not supported on provider: " + providerName
    ...
    public void testInvalidDHKeySize() throws Exception {
        ...
        System.out.println("Testing invalid keypair sizes with provider: " + providerName);
        ...
        for (int keypairSize : keypairSizes) {
            ...
            try {
                ...
                System.out.print(" Keysize: (" + keypairSize + ") not supported on provider: "
                        + providerName + "<===Expected InvalidParameterException caught");
            } finally {
                System.out.println("");
            }
        }
