...
public class BaseTestHmacSHA384Interop extends BaseTestInterop {
    //--------------------------------------------------------------------------
    //
    //
    ...
    //
    //
    public BaseTestHmacSHA384Interop(String providerName, String interopProviderName) {
    ...
    public void warmup() throws Exception {
        ...
        try {
            Mac mac = Mac.getInstance("HmacSHA384", providerName);
