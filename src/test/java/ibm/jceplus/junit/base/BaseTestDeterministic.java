...
public class BaseTestDeterministic extends BaseTestJunit5 {
        ...
        for (var s : p.getServices()) {
            switch (s.getType()) {
                ...
                case "AlgorithmParameterGenerator":
                    testAlgorithmParameterGenerator(s);
                    break;
            }
        }
    }
    ...
    static void testAlgorithmParameterGenerator(Provider.Service s) throws Exception {
        ...
        if (p1 instanceof DSAParameterSpec && p2 instanceof DSAParameterSpec) {
            DSAParameterSpec d1 = (DSAParameterSpec) p1;
            DSAParameterSpec d2 = (DSAParameterSpec) p2;
            ...
            DHParameterSpec d1 = (DHParameterSpec) p1;
            DHParameterSpec d2 = (DHParameterSpec) p2;
            assertEquals(d1.getG(), d2.getG());
            assertEquals(d1.getP(), d2.getP());
