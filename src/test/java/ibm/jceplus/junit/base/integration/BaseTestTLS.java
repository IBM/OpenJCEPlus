...
public class BaseTestTLS {
    ...
    public static void insertProvider(String providerName, int position) throws Exception {
    ...
    public void runServerClient(String tlsProtocol, String keyType, String cipher) throws Exception {
        System.out.println("Testing " + tlsProtocol + " " + keyType + " " + cipher);
        CountDownLatch serverReady = new CountDownLatch(1);
        Server server = new Server(tlsProtocol, KeyType.valueOf(keyType), cipher, serverReady);
        server.start();

        // Wait till server is ready to accept connection.
        serverReady.await();
        new Client(tlsProtocol, KeyType.valueOf(keyType), cipher, server.port).doClientSide();
    ...
    enum KeyType {
        ...
        dsa_sha256(
                 ...
                 */
                "-----BEGIN CERTIFICATE-----\n"
                + "MIIFEzCCBMGgAwIBAgIUGOhwXXokYVAuUu7ByLnzwE/Du3QwCwYJYIZIAWUDBAMC\n"
                + "MG0xCzAJBgNVBAYTAkNBMQ0wCwYDVQQIDARUZXN0MQ0wCwYDVQQHDARUZXN0MQ0w\n"
                + "CwYDVQQKDARUZXN0MQ0wCwYDVQQLDARUZXN0MQ0wCwYDVQQDDARUZXN0MRMwEQYJ\n"
                + "KoZIhvcNAQkBFgR0ZXN0MB4XDTI0MDQwMzE3MjUwM1oXDTI1MDQwMzE3MjUwM1ow\n"
                + "bTELMAkGA1UEBhMCQ0ExDTALBgNVBAgMBFRlc3QxDTALBgNVBAcMBFRlc3QxDTAL\n"
                + "BgNVBAoMBFRlc3QxDTALBgNVBAsMBFRlc3QxDTALBgNVBAMMBFRlc3QxEzARBgkq\n"
                + "hkiG9w0BCQEWBHRlc3QwggNCMIICNQYHKoZIzjgEATCCAigCggEBAI9wZ+K7jOMn\n"
                + "0txo53k8QscwZeK9AJXQ0mrxMI5w8+jxyfAV9CDcF7oZJsUyxO3PxAv33g7iWDDa\n"
                + "ryyHGWr36DRWY5sOSsloV3k0bTYqA5zr4BSI08Z9YFuJ7moUWi66GwSRilgatD7e\n"
                + "noBDtT/0v84hk8srN8QcvN/iLVFwb4azAgAZBt4ePfGFrd35HE+wQrADs5ZGgjyw\n"
                + "ADK+HfS8BUOWDrvtHoBkC3FS0UEEpF/uBwx9jwnMFRZ0z++J3rYlN6jEsAcpRFPX\n"
                + "cTAKvknV7pSDJkfApsduhPWWPmrZxNONcboZoGCePd8b5+8LcEkYH7bZZYzW3qMu\n"
                + "+Uc0YI5xCWkCHQDnV1FiUrWsVSlR+fiHgmDNaiBnByy6965//jpJAoIBACakcWgn\n"
                + "YvMCBqYIg6GHB+UP0FfvTn4rM3vBvcleYuFevIYA24Jg681fzkW59eokPtLwxxvz\n"
                + "Ee6CsmSvGP7ebIpeccuJJ3hhqc11d2kx/ASbYnW6d2z5sJJu6nQ82Za3Q9NjENU5\n"
                + "31pzXgOQW3dAwRMqGeusvUOnoKtaj8mb4ZuHMIyNsBrFTVFLDBXGbKgcme46IMxV\n"
                + "iDBPRIq7hpuaEPjP4IV9DXAOLoA9MHvWgawy3Q8d7qosf9lxs+x6OKi02IAX/RHa\n"
                + "M4U35dK7jMiTJqKhQ2EzH5Sj0jybXqSq7SLyqWTx1e/mQBo3ztslP/JmvgySDDnq\n"
                + "NaCTUngNTRT/oWUDggEFAAKCAQAZTTRgowSmBIqAjX9EPTREqMJw4wZskUJPRnas\n"
                + "kzPOfT+M+sr8P4zRQszXhBQGD4pTNO3lsU5J7mkxyPYZ3e+ZSyYC5VKqWs9pxZlQ\n"
                + "owksnJFQYIUD4eiR2yKvV5zZZiJgigmpl9OBDO4BgNka8kH8/sj+SP2FpB0Pj0mi\n"
                + "JazcxrhG5E2kO9zDX6XTe2ED6CpYrXGep0HWCa2gEYtd04QdcJ4j3vMrkNO/maiS\n"
                + "568oabbsO9a4xbQT4iXwE6HlT1EYOO1ju3hCJ1ByETCzBtdM2ZSGaNZ8yQvmCMQs\n"
                + "raDBkEwLqxrWvk6uPJ+A8XkGrUGPsOJ6ns2xYLaQK4Inri4xo1MwUTAdBgNVHQ4E\n"
                + "FgQUQjaq5s4Ot00EZ8SCnxPMZtKuExgwHwYDVR0jBBgwFoAUQjaq5s4Ot00EZ8SC\n"
                + "nxPMZtKuExgwDwYDVR0TAQH/BAUwAwEB/zALBglghkgBZQMEAwIDPwAwPAIcKJHu\n"
                + "VPBbLpiXGe3QPgcM/9qVFJpe94vmWl4QswIcJShgcoM818W9A+gYTDTAkqZmvIbk\n"
                + "OwES1xFhBg==\n"
                + "-----END CERTIFICATE-----\n",
                //
                // Private key.
                //
                "MIICXAIBADCCAjUGByqGSM44BAEwggIoAoIBAQCPcGfiu4zjJ9LcaOd5PELHMGXi\n"
                + "vQCV0NJq8TCOcPPo8cnwFfQg3Be6GSbFMsTtz8QL994O4lgw2q8shxlq9+g0VmOb\n"
                + "DkrJaFd5NG02KgOc6+AUiNPGfWBbie5qFFouuhsEkYpYGrQ+3p6AQ7U/9L/OIZPL\n"
                + "KzfEHLzf4i1RcG+GswIAGQbeHj3xha3d+RxPsEKwA7OWRoI8sAAyvh30vAVDlg67\n"
                + "7R6AZAtxUtFBBKRf7gcMfY8JzBUWdM/vid62JTeoxLAHKURT13EwCr5J1e6UgyZH\n"
                + "wKbHboT1lj5q2cTTjXG6GaBgnj3fG+fvC3BJGB+22WWM1t6jLvlHNGCOcQlpAh0A\n"
                + "51dRYlK1rFUpUfn4h4JgzWogZwcsuveuf/46SQKCAQAmpHFoJ2LzAgamCIOhhwfl\n"
                + "D9BX705+KzN7wb3JXmLhXryGANuCYOvNX85FufXqJD7S8Mcb8xHugrJkrxj+3myK\n"
                + "XnHLiSd4YanNdXdpMfwEm2J1unds+bCSbup0PNmWt0PTYxDVOd9ac14DkFt3QMET\n"
                + "KhnrrL1Dp6CrWo/Jm+GbhzCMjbAaxU1RSwwVxmyoHJnuOiDMVYgwT0SKu4abmhD4\n"
                + "z+CFfQ1wDi6APTB71oGsMt0PHe6qLH/ZcbPsejiotNiAF/0R2jOFN+XSu4zIkyai\n"
                + "oUNhMx+Uo9I8m16kqu0i8qlk8dXv5kAaN87bJT/yZr4Mkgw56jWgk1J4DU0U/6Fl\n"
                + "BB4CHFVBnaknc0pVCe38qDf3y3dqFhzJp48MTN33F0o=\n"
        );
