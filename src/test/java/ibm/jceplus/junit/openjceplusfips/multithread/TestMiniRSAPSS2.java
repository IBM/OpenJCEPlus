...
import ibm.jceplus.junit.base.BaseTestMiniRSAPSS2;
...
public class TestMiniRSAPSS2 extends ibm.jceplus.junit.base.BaseTestMiniRSAPSS2 {
    ...
    public static void main(String[] args) throws Exception {
        String[] nargs = {
                ibm.jceplus.junit.openjceplusfips.multithread.TestMiniRSAPSS2.class.getName()};
    ...
    //
    //
    public void testMiniRSAPSS2() throws Exception {
        System.out.println("executing testRSAPSS2");
        BaseTestMiniRSAPSS2 bt = new BaseTestMiniRSAPSS2(providerName);
        bt.run();
    }
