 ...
 * Signature: (JI)J
 */
JNIEXPORT jlong JNICALL Java_com_ibm_crypto_plus_provider_ock_NativeInterface_RSAKEY_1generate
 ...
 * Signature: (J[B)J
 */
JNIEXPORT jlong JNICALL Java_com_ibm_crypto_plus_provider_ock_NativeInterface_RSAKEY_1createPrivateKey
 ...
 * Signature: (J[B)J
 */
JNIEXPORT jlong JNICALL Java_com_ibm_crypto_plus_provider_ock_NativeInterface_RSAKEY_1createPublicKey
 ...
 * Signature: (JJ)[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_ibm_crypto_plus_provider_ock_NativeInterface_RSAKEY_1getPrivateKeyBytes
  (JNIEnv * env, jclass thisObj, jlong ockContextId, jlong rsaKeyId)
{
  static const char * functionName = "NativeInterface.RSAKEY_getPrivateKeyBytes";
 ...
 * Signature: (JJ)[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_ibm_crypto_plus_provider_ock_NativeInterface_RSAKEY_1getPublicKeyBytes
  (JNIEnv *env, jclass thisObj, jlong ockContextId, jlong rsaKeyId )
{
  static const char * functionName = "NativeInterface.RSAKEY_getPublicKeyBytes";
...
#ifdef DEBUG_RSA_DETAIL
          if ( debug ) {
            gslogMessage ("DETAIL_RSA rsaKeyId %lx size %d ", (long) rsaKeyId, (int) size);
          }
#endif
  if( size <= 0 ) {
#ifdef DEBUG_RSA_DETAIL
 ...
 * Signature: (JJ)J
 */
JNIEXPORT jlong JNICALL Java_com_ibm_crypto_plus_provider_ock_NativeInterface_RSAKEY_1createPKey
  (JNIEnv * env, jclass thisObj, jlong ockContextId, jlong rsaKeyId)
{
 ...
 * Signature: (JJ)I
 */
JNIEXPORT jint JNICALL Java_com_ibm_crypto_plus_provider_ock_NativeInterface_RSAKEY_1size
  (JNIEnv *env, jclass thisObj, jlong ockContextId, jlong rsaKeyId) {
 ...
 * Signature: (JJ)V
 */
JNIEXPORT void JNICALL Java_com_ibm_crypto_plus_provider_ock_NativeInterface_RSAKEY_1delete
  (JNIEnv *env, jclass thisObj, jlong ockContextId, jlong rsaKeyId)
{
