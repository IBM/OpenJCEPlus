...
abstract class PBMAC1Core extends HmacCore {
    ...
    private PBKDF2Core getKDFImpl(String algo) {
        PBKDF2Core kdf;
        String ockDigestAlgo = "PBEWith" + algo.replace('-', '/');
        switch (algo) {
            case "HmacSHA1":
                kdf = new PBKDF2Core.HmacSHA1(provider, "Mac", ockDigestAlgo);
                break;
            case "HmacSHA224":
                kdf = new PBKDF2Core.HmacSHA224(provider, "Mac", ockDigestAlgo);
                break;
            case "HmacSHA256":
                kdf = new PBKDF2Core.HmacSHA256(provider, "Mac", ockDigestAlgo);
                break;
            case "HmacSHA384":
                kdf = new PBKDF2Core.HmacSHA384(provider, "Mac", ockDigestAlgo);
                break;
            case "HmacSHA512":
                kdf = new PBKDF2Core.HmacSHA512(provider, "Mac", ockDigestAlgo);
                break;
            case "HmacSHA512-224":
                kdf = new PBKDF2Core.HmacSHA512_224(provider, "Mac", ockDigestAlgo);
                break;
            case "HmacSHA512-256":
                kdf = new PBKDF2Core.HmacSHA512_256(provider, "Mac", ockDigestAlgo);
                break;
            default:
