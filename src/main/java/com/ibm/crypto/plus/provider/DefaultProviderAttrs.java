...
class DefaultProviderAttrs {
    ...
    static String defaultProvAttrs = "Service.AlgorithmParameters.AES = com.ibm.crypto.plus.provider.AESParameters\n"
        ...
        + "# =======================================================================\n"
        + " # Composite PQ signatures (draft-ietf-lamps-pq-composite-sigs-09)\n"
        + " # =======================================================================\n"
        + " #\n"
        // MLDSA44-RSA2048-PSS-SHA256  OID .20
        + "KeyPairGenerator.MLDSA44-RSA2048-PSS-SHA256.alias.add = OID.2.16.840.1.114027.80.9.1.20, 2.16.840.1.114027.80.9.1.20\n"
        + "Service.KeyPairGenerator.MLDSA44-RSA2048-PSS-SHA256 = com.ibm.crypto.plus.provider.CompositeKeyPairGenerator$MLDSA44RSA2048PSSSHA256\n"
        + "KeyFactory.MLDSA44-RSA2048-PSS-SHA256.alias.add = OID.2.16.840.1.114027.80.9.1.20, 2.16.840.1.114027.80.9.1.20\n"
        + "Service.KeyFactory.MLDSA44-RSA2048-PSS-SHA256 = com.ibm.crypto.plus.provider.CompositeKeyFactory$MLDSA44RSA2048PSSSHA256\n"
        + "Signature.MLDSA44-RSA2048-PSS-SHA256.alias.add = OID.2.16.840.1.114027.80.9.1.20, 2.16.840.1.114027.80.9.1.20\n"
        + "Service.Signature.MLDSA44-RSA2048-PSS-SHA256 = com.ibm.crypto.plus.provider.CompositeSignatureImpl$MLDSA44RSA2048PSSSHA256\n"
        // MLDSA44-RSA2048-PKCS15-SHA256  OID .21
        + "KeyPairGenerator.MLDSA44-RSA2048-PKCS15-SHA256.alias.add = OID.2.16.840.1.114027.80.9.1.21, 2.16.840.1.114027.80.9.1.21\n"
        + "Service.KeyPairGenerator.MLDSA44-RSA2048-PKCS15-SHA256 = com.ibm.crypto.plus.provider.CompositeKeyPairGenerator$MLDSA44RSA2048PKCS15SHA256\n"
        + "KeyFactory.MLDSA44-RSA2048-PKCS15-SHA256.alias.add = OID.2.16.840.1.114027.80.9.1.21, 2.16.840.1.114027.80.9.1.21\n"
        + "Service.KeyFactory.MLDSA44-RSA2048-PKCS15-SHA256 = com.ibm.crypto.plus.provider.CompositeKeyFactory$MLDSA44RSA2048PKCS15SHA256\n"
        + "Signature.MLDSA44-RSA2048-PKCS15-SHA256.alias.add = OID.2.16.840.1.114027.80.9.1.21, 2.16.840.1.114027.80.9.1.21\n"
        + "Service.Signature.MLDSA44-RSA2048-PKCS15-SHA256 = com.ibm.crypto.plus.provider.CompositeSignatureImpl$MLDSA44RSA2048PKCS15SHA256\n"
        // MLDSA44-Ed25519  OID .22
        + "KeyPairGenerator.MLDSA44-Ed25519.alias.add = OID.2.16.840.1.114027.80.9.1.22, 2.16.840.1.114027.80.9.1.22\n"
        + "Service.KeyPairGenerator.MLDSA44-Ed25519 = com.ibm.crypto.plus.provider.CompositeKeyPairGenerator$MLDSA44Ed25519\n"
        + "KeyFactory.MLDSA44-Ed25519.alias.add = OID.2.16.840.1.114027.80.9.1.22, 2.16.840.1.114027.80.9.1.22\n"
        + "Service.KeyFactory.MLDSA44-Ed25519 = com.ibm.crypto.plus.provider.CompositeKeyFactory$MLDSA44Ed25519\n"
        + "Signature.MLDSA44-Ed25519.alias.add = OID.2.16.840.1.114027.80.9.1.22, 2.16.840.1.114027.80.9.1.22\n"
        + "Service.Signature.MLDSA44-Ed25519 = com.ibm.crypto.plus.provider.CompositeSignatureImpl$MLDSA44Ed25519\n"
        // MLDSA44-ECDSA-P256-SHA256  OID .23
        + "KeyPairGenerator.MLDSA44-ECDSA-P256-SHA256.alias.add = OID.2.16.840.1.114027.80.9.1.23, 2.16.840.1.114027.80.9.1.23\n"
        + "Service.KeyPairGenerator.MLDSA44-ECDSA-P256-SHA256 = com.ibm.crypto.plus.provider.CompositeKeyPairGenerator$MLDSA44ECDSAP256SHA256\n"
        + "KeyFactory.MLDSA44-ECDSA-P256-SHA256.alias.add = OID.2.16.840.1.114027.80.9.1.23, 2.16.840.1.114027.80.9.1.23\n"
        + "Service.KeyFactory.MLDSA44-ECDSA-P256-SHA256 = com.ibm.crypto.plus.provider.CompositeKeyFactory$MLDSA44ECDSAP256SHA256\n"
        + "Signature.MLDSA44-ECDSA-P256-SHA256.alias.add = OID.2.16.840.1.114027.80.9.1.23, 2.16.840.1.114027.80.9.1.23\n"
        + "Service.Signature.MLDSA44-ECDSA-P256-SHA256 = com.ibm.crypto.plus.provider.CompositeSignatureImpl$MLDSA44ECDSAP256SHA256\n"
        // MLDSA65-RSA3072-PSS-SHA512  OID .24
        + "KeyPairGenerator.MLDSA65-RSA3072-PSS-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.24, 2.16.840.1.114027.80.9.1.24\n"
        + "Service.KeyPairGenerator.MLDSA65-RSA3072-PSS-SHA512 = com.ibm.crypto.plus.provider.CompositeKeyPairGenerator$MLDSA65RSA3072PSSSHA512\n"
        + "KeyFactory.MLDSA65-RSA3072-PSS-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.24, 2.16.840.1.114027.80.9.1.24\n"
        + "Service.KeyFactory.MLDSA65-RSA3072-PSS-SHA512 = com.ibm.crypto.plus.provider.CompositeKeyFactory$MLDSA65RSA3072PSSSHA512\n"
        + "Signature.MLDSA65-RSA3072-PSS-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.24, 2.16.840.1.114027.80.9.1.24\n"
        + "Service.Signature.MLDSA65-RSA3072-PSS-SHA512 = com.ibm.crypto.plus.provider.CompositeSignatureImpl$MLDSA65RSA3072PSSSHA512\n"
        // MLDSA65-RSA3072-PKCS15-SHA512  OID .25
        + "KeyPairGenerator.MLDSA65-RSA3072-PKCS15-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.25, 2.16.840.1.114027.80.9.1.25\n"
        + "Service.KeyPairGenerator.MLDSA65-RSA3072-PKCS15-SHA512 = com.ibm.crypto.plus.provider.CompositeKeyPairGenerator$MLDSA65RSA3072PKCS15SHA512\n"
        + "KeyFactory.MLDSA65-RSA3072-PKCS15-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.25, 2.16.840.1.114027.80.9.1.25\n"
        + "Service.KeyFactory.MLDSA65-RSA3072-PKCS15-SHA512 = com.ibm.crypto.plus.provider.CompositeKeyFactory$MLDSA65RSA3072PKCS15SHA512\n"
        + "Signature.MLDSA65-RSA3072-PKCS15-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.25, 2.16.840.1.114027.80.9.1.25\n"
        + "Service.Signature.MLDSA65-RSA3072-PKCS15-SHA512 = com.ibm.crypto.plus.provider.CompositeSignatureImpl$MLDSA65RSA3072PKCS15SHA512\n"
        // MLDSA65-RSA4096-PSS-SHA512  OID .26
        + "KeyPairGenerator.MLDSA65-RSA4096-PSS-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.26, 2.16.840.1.114027.80.9.1.26\n"
        + "Service.KeyPairGenerator.MLDSA65-RSA4096-PSS-SHA512 = com.ibm.crypto.plus.provider.CompositeKeyPairGenerator$MLDSA65RSA4096PSSSHA512\n"
        + "KeyFactory.MLDSA65-RSA4096-PSS-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.26, 2.16.840.1.114027.80.9.1.26\n"
        + "Service.KeyFactory.MLDSA65-RSA4096-PSS-SHA512 = com.ibm.crypto.plus.provider.CompositeKeyFactory$MLDSA65RSA4096PSSSHA512\n"
        + "Signature.MLDSA65-RSA4096-PSS-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.26, 2.16.840.1.114027.80.9.1.26\n"
        + "Service.Signature.MLDSA65-RSA4096-PSS-SHA512 = com.ibm.crypto.plus.provider.CompositeSignatureImpl$MLDSA65RSA4096PSSSHA512\n"
        // MLDSA65-RSA4096-PKCS15-SHA512  OID .27
        + "KeyPairGenerator.MLDSA65-RSA4096-PKCS15-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.27, 2.16.840.1.114027.80.9.1.27\n"
        + "Service.KeyPairGenerator.MLDSA65-RSA4096-PKCS15-SHA512 = com.ibm.crypto.plus.provider.CompositeKeyPairGenerator$MLDSA65RSA4096PKCS15SHA512\n"
        + "KeyFactory.MLDSA65-RSA4096-PKCS15-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.27, 2.16.840.1.114027.80.9.1.27\n"
        + "Service.KeyFactory.MLDSA65-RSA4096-PKCS15-SHA512 = com.ibm.crypto.plus.provider.CompositeKeyFactory$MLDSA65RSA4096PKCS15SHA512\n"
        + "Signature.MLDSA65-RSA4096-PKCS15-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.27, 2.16.840.1.114027.80.9.1.27\n"
        + "Service.Signature.MLDSA65-RSA4096-PKCS15-SHA512 = com.ibm.crypto.plus.provider.CompositeSignatureImpl$MLDSA65RSA4096PKCS15SHA512\n"
        // MLDSA65-ECDSA-P256-SHA512  OID .28
        + "KeyPairGenerator.MLDSA65-ECDSA-P256-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.28, 2.16.840.1.114027.80.9.1.28\n"
        + "Service.KeyPairGenerator.MLDSA65-ECDSA-P256-SHA512 = com.ibm.crypto.plus.provider.CompositeKeyPairGenerator$MLDSA65ECDSAP256SHA512\n"
        + "KeyFactory.MLDSA65-ECDSA-P256-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.28, 2.16.840.1.114027.80.9.1.28\n"
        + "Service.KeyFactory.MLDSA65-ECDSA-P256-SHA512 = com.ibm.crypto.plus.provider.CompositeKeyFactory$MLDSA65ECDSAP256SHA512\n"
        + "Signature.MLDSA65-ECDSA-P256-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.28, 2.16.840.1.114027.80.9.1.28\n"
        + "Service.Signature.MLDSA65-ECDSA-P256-SHA512 = com.ibm.crypto.plus.provider.CompositeSignatureImpl$MLDSA65ECDSAP256SHA512\n"
        // MLDSA65-ECDSA-P384-SHA512  OID .29
        + "KeyPairGenerator.MLDSA65-ECDSA-P384-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.29, 2.16.840.1.114027.80.9.1.29\n"
        + "Service.KeyPairGenerator.MLDSA65-ECDSA-P384-SHA512 = com.ibm.crypto.plus.provider.CompositeKeyPairGenerator$MLDSA65ECDSAP384SHA512\n"
        + "KeyFactory.MLDSA65-ECDSA-P384-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.29, 2.16.840.1.114027.80.9.1.29\n"
        + "Service.KeyFactory.MLDSA65-ECDSA-P384-SHA512 = com.ibm.crypto.plus.provider.CompositeKeyFactory$MLDSA65ECDSAP384SHA512\n"
        + "Signature.MLDSA65-ECDSA-P384-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.29, 2.16.840.1.114027.80.9.1.29\n"
        + "Service.Signature.MLDSA65-ECDSA-P384-SHA512 = com.ibm.crypto.plus.provider.CompositeSignatureImpl$MLDSA65ECDSAP384SHA512\n"
        // MLDSA65-ECDSA-brainpoolP256r1-SHA512  OID .30
        + "KeyPairGenerator.MLDSA65-ECDSA-brainpoolP256r1-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.30, 2.16.840.1.114027.80.9.1.30\n"
        + "Service.KeyPairGenerator.MLDSA65-ECDSA-brainpoolP256r1-SHA512 = com.ibm.crypto.plus.provider.CompositeKeyPairGenerator$MLDSA65ECDSABrainpoolP256r1SHA512\n"
        + "KeyFactory.MLDSA65-ECDSA-brainpoolP256r1-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.30, 2.16.840.1.114027.80.9.1.30\n"
        + "Service.KeyFactory.MLDSA65-ECDSA-brainpoolP256r1-SHA512 = com.ibm.crypto.plus.provider.CompositeKeyFactory$MLDSA65ECDSABrainpoolP256r1SHA512\n"
        + "Signature.MLDSA65-ECDSA-brainpoolP256r1-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.30, 2.16.840.1.114027.80.9.1.30\n"
        + "Service.Signature.MLDSA65-ECDSA-brainpoolP256r1-SHA512 = com.ibm.crypto.plus.provider.CompositeSignatureImpl$MLDSA65ECDSABrainpoolP256r1SHA512\n"
        // MLDSA65-Ed25519  OID .31
        + "KeyPairGenerator.MLDSA65-Ed25519.alias.add = OID.2.16.840.1.114027.80.9.1.31, 2.16.840.1.114027.80.9.1.31\n"
        + "Service.KeyPairGenerator.MLDSA65-Ed25519 = com.ibm.crypto.plus.provider.CompositeKeyPairGenerator$MLDSA65Ed25519\n"
        + "KeyFactory.MLDSA65-Ed25519.alias.add = OID.2.16.840.1.114027.80.9.1.31, 2.16.840.1.114027.80.9.1.31\n"
        + "Service.KeyFactory.MLDSA65-Ed25519 = com.ibm.crypto.plus.provider.CompositeKeyFactory$MLDSA65Ed25519\n"
        + "Signature.MLDSA65-Ed25519.alias.add = OID.2.16.840.1.114027.80.9.1.31, 2.16.840.1.114027.80.9.1.31\n"
        + "Service.Signature.MLDSA65-Ed25519 = com.ibm.crypto.plus.provider.CompositeSignatureImpl$MLDSA65Ed25519\n"
        // MLDSA87-ECDSA-P384-SHA512  OID .32
        + "KeyPairGenerator.MLDSA87-ECDSA-P384-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.32, 2.16.840.1.114027.80.9.1.32\n"
        + "Service.KeyPairGenerator.MLDSA87-ECDSA-P384-SHA512 = com.ibm.crypto.plus.provider.CompositeKeyPairGenerator$MLDSA87ECDSAP384SHA512\n"
        + "KeyFactory.MLDSA87-ECDSA-P384-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.32, 2.16.840.1.114027.80.9.1.32\n"
        + "Service.KeyFactory.MLDSA87-ECDSA-P384-SHA512 = com.ibm.crypto.plus.provider.CompositeKeyFactory$MLDSA87ECDSAP384SHA512\n"
        + "Signature.MLDSA87-ECDSA-P384-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.32, 2.16.840.1.114027.80.9.1.32\n"
        + "Service.Signature.MLDSA87-ECDSA-P384-SHA512 = com.ibm.crypto.plus.provider.CompositeSignatureImpl$MLDSA87ECDSAP384SHA512\n"
        // MLDSA87-ECDSA-brainpoolP384r1-SHA512  OID .33
        + "KeyPairGenerator.MLDSA87-ECDSA-brainpoolP384r1-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.33, 2.16.840.1.114027.80.9.1.33\n"
        + "Service.KeyPairGenerator.MLDSA87-ECDSA-brainpoolP384r1-SHA512 = com.ibm.crypto.plus.provider.CompositeKeyPairGenerator$MLDSA87ECDSABrainpoolP384r1SHA512\n"
        + "KeyFactory.MLDSA87-ECDSA-brainpoolP384r1-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.33, 2.16.840.1.114027.80.9.1.33\n"
        + "Service.KeyFactory.MLDSA87-ECDSA-brainpoolP384r1-SHA512 = com.ibm.crypto.plus.provider.CompositeKeyFactory$MLDSA87ECDSABrainpoolP384r1SHA512\n"
        + "Signature.MLDSA87-ECDSA-brainpoolP384r1-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.33, 2.16.840.1.114027.80.9.1.33\n"
        + "Service.Signature.MLDSA87-ECDSA-brainpoolP384r1-SHA512 = com.ibm.crypto.plus.provider.CompositeSignatureImpl$MLDSA87ECDSABrainpoolP384r1SHA512\n"
        // MLDSA87-Ed448  OID .34
        + "KeyPairGenerator.MLDSA87-Ed448.alias.add = OID.2.16.840.1.114027.80.9.1.34, 2.16.840.1.114027.80.9.1.34\n"
        + "Service.KeyPairGenerator.MLDSA87-Ed448 = com.ibm.crypto.plus.provider.CompositeKeyPairGenerator$MLDSA87Ed448\n"
        + "KeyFactory.MLDSA87-Ed448.alias.add = OID.2.16.840.1.114027.80.9.1.34, 2.16.840.1.114027.80.9.1.34\n"
        + "Service.KeyFactory.MLDSA87-Ed448 = com.ibm.crypto.plus.provider.CompositeKeyFactory$MLDSA87Ed448\n"
        + "Signature.MLDSA87-Ed448.alias.add = OID.2.16.840.1.114027.80.9.1.34, 2.16.840.1.114027.80.9.1.34\n"
        + "Service.Signature.MLDSA87-Ed448 = com.ibm.crypto.plus.provider.CompositeSignatureImpl$MLDSA87Ed448\n"
        // MLDSA87-RSA3072-PSS-SHA512  OID .35
        + "KeyPairGenerator.MLDSA87-RSA3072-PSS-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.35, 2.16.840.1.114027.80.9.1.35\n"
        + "Service.KeyPairGenerator.MLDSA87-RSA3072-PSS-SHA512 = com.ibm.crypto.plus.provider.CompositeKeyPairGenerator$MLDSA87RSA3072PSSSHA512\n"
        + "KeyFactory.MLDSA87-RSA3072-PSS-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.35, 2.16.840.1.114027.80.9.1.35\n"
        + "Service.KeyFactory.MLDSA87-RSA3072-PSS-SHA512 = com.ibm.crypto.plus.provider.CompositeKeyFactory$MLDSA87RSA3072PSSSHA512\n"
        + "Signature.MLDSA87-RSA3072-PSS-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.35, 2.16.840.1.114027.80.9.1.35\n"
        + "Service.Signature.MLDSA87-RSA3072-PSS-SHA512 = com.ibm.crypto.plus.provider.CompositeSignatureImpl$MLDSA87RSA3072PSSSHA512\n"
        // MLDSA87-RSA4096-PSS-SHA512  OID .36
        + "KeyPairGenerator.MLDSA87-RSA4096-PSS-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.36, 2.16.840.1.114027.80.9.1.36\n"
        + "Service.KeyPairGenerator.MLDSA87-RSA4096-PSS-SHA512 = com.ibm.crypto.plus.provider.CompositeKeyPairGenerator$MLDSA87RSA4096PSSSHA512\n"
        + "KeyFactory.MLDSA87-RSA4096-PSS-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.36, 2.16.840.1.114027.80.9.1.36\n"
        + "Service.KeyFactory.MLDSA87-RSA4096-PSS-SHA512 = com.ibm.crypto.plus.provider.CompositeKeyFactory$MLDSA87RSA4096PSSSHA512\n"
        + "Signature.MLDSA87-RSA4096-PSS-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.36, 2.16.840.1.114027.80.9.1.36\n"
        + "Service.Signature.MLDSA87-RSA4096-PSS-SHA512 = com.ibm.crypto.plus.provider.CompositeSignatureImpl$MLDSA87RSA4096PSSSHA512\n"
        // MLDSA87-ECDSA-P521-SHA512  OID .37
        + "KeyPairGenerator.MLDSA87-ECDSA-P521-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.37, 2.16.840.1.114027.80.9.1.37\n"
        + "Service.KeyPairGenerator.MLDSA87-ECDSA-P521-SHA512 = com.ibm.crypto.plus.provider.CompositeKeyPairGenerator$MLDSA87ECDSAP521SHA512\n"
        + "KeyFactory.MLDSA87-ECDSA-P521-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.37, 2.16.840.1.114027.80.9.1.37\n"
        + "Service.KeyFactory.MLDSA87-ECDSA-P521-SHA512 = com.ibm.crypto.plus.provider.CompositeKeyFactory$MLDSA87ECDSAP521SHA512\n"
        + "Signature.MLDSA87-ECDSA-P521-SHA512.alias.add = OID.2.16.840.1.114027.80.9.1.37, 2.16.840.1.114027.80.9.1.37\n"
        + "Service.Signature.MLDSA87-ECDSA-P521-SHA512 = com.ibm.crypto.plus.provider.CompositeSignatureImpl$MLDSA87ECDSAP521SHA512\n";
