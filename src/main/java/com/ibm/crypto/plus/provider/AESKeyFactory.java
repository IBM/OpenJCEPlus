...
/**
 * This class implements the AES key factory.
 */
public final class AESKeyFactory extends SecretKeyFactorySpi {
    ...
    protected KeySpec engineGetKeySpec(SecretKey key, Class<?> keySpec)
        ...
        // try {
        if ((key instanceof SecretKey) && (key.getAlgorithm().equalsIgnoreCase("AES"))
    ...
    protected SecretKey engineTranslateKey(SecretKey key) throws InvalidKeyException {
        try {
            if ((key != null) && (key.getAlgorithm().equalsIgnoreCase("AES"))
                ...
                if (key instanceof com.ibm.crypto.plus.provider.AESKey) {
                    return key;
                }
