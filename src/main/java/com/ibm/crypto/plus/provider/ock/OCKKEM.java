...
public final class OCKKEM implements Cloneable {
    ...
    public static void OCKKEM_encapsulate(OCKContext ockContext, long ockPKeyId, byte[] encapsulatedKey,
    ...
    public static byte[] OCKKEM_decapsulate(OCKContext ockContext, long ockPKeyId, byte[] encapsulatedKey)
            throws OCKException {
        byte[] keyMaterial = 
