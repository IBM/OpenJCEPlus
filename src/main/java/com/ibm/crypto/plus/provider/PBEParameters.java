...
abstract class PBEParameters extends AlgorithmParametersSpi {
    ...
    public static final class MD5AndDES extends PBEParameters {
        public MD5AndDES() throws NoSuchAlgorithmException {
            super("PBEWithMD5AndDES");
        }
    }

    public static final class SHA1AndDESede extends PBEParameters {
        public SHA1AndDESede() throws NoSuchAlgorithmException {
    ...
    public static final class SHA1AndRC2_128 extends PBEParameters {
        public SHA1AndRC2_128() throws NoSuchAlgorithmException {
            super("PBEWithSHA1RC2_128");
        }
    }

    public static final class SHA1AndRC4_40 extends PBEParameters {
        public SHA1AndRC4_40() throws NoSuchAlgorithmException {
            super("PBEWithSHA1AndRC4_40");
        }
    }

    public static final class SHA1AndRC4_128 extends PBEParameters {
        public SHA1AndRC4_128() throws NoSuchAlgorithmException {
