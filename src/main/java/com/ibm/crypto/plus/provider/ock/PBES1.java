    ...
    public static byte[] PBEdoFinal(OCKContext ockContext, String algorithm, final byte[] password, byte[] salt, 
        ...
        switch (algorithm) {
            case "PBEWithMD5AndDES":
                text = "1.2.840.113549.1.5.3".getBytes();
                break;
            case "PBEWithSHA1AndDESede":
                text = "1.2.840.113549.1.12.1.3".getBytes();
                break;
            case "PBEWithSHA1AndRC2_40":
                text = "1.2.840.113549.1.12.1.6".getBytes();
                break;
            case "PBEWithSHA1AndRC2_128":
                text = "1.2.840.113549.1.12.1.5".getBytes();
                break;
            case "PBEWithSHA1AndRC4_40":
                text = "1.2.840.113549.1.12.1.2".getBytes();
                break;
            case "PBEWithSHA1AndRC4_128":
                text = "1.2.840.113549.1.12.1.1".getBytes();
                break;
            default:
