...
public final class ECDHKeyAgreement extends KeyAgreementSpi { // implements
    ...
    private static boolean disableSmallCurve = Boolean.parseBoolean(System.getProperty("com.ibm.crypto.plus.provider.disableSmallerECKeySizeForSharedKeyComputing","false"));
    ...
    protected byte[] engineGenerateSecret() throws IllegalStateException {
        ...
        if (provider.isFIPS() && disableSmallCurve) {
            ...
            if (!((oidPubKey.toString()).equals("1.2.840.10045.3.1.7") // secp256r1 [NIST P-256, X9.62 prime256v1]
                ...
                || (oidPubKey.toString()).equals("1.3.132.0.35")) // secp521r1 [NIST P-521]
            ) {
                throw new IllegalStateException(ecPriKeyNamedCurve.getName() + " curve is not supported in FIPS for calculating the shared secret");
            }
        }
